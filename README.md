...
### Software
To automatically install all listed Software, please install [Chocolatey](https://chocolatey.org/) and run [./setup/installSoftware.cmd](installSoftware.cmd) script.
